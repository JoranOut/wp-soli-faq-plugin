...
const PLUGIN_PATH = '/var/www/html/wp-content/plugins/wp-soli-faq-plugin';
...
/**
 * Seed the fixture content (a published FAQ and a page with a
 * FAQs query loop) and return { faqId, faqUrl, pageUrl }.
 */
function seedFixtures() {
	// --user=admin: the plugin hides FAQs from logged-out queries,
